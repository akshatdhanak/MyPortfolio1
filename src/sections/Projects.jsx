...
const projects = [
  {
    id: "01",
    title: "MeetFlow AI",
    sub: "AI Meeting Platform",
    desc: "Architected a full-stack AI platform serving 43 REST API endpoints with Supabase auth, RLS, and Drizzle ORM. Built a multi-provider STT pipeline (Groq, Sarvam) with automated failover and LLM-driven artifact generation. Designed an idempotent workflow engine for real-time processing; integrated Jira, Linear, and GitHub via OAuth 2.0. Developed a companion Chrome extension with background service workers.",
    tags: ["Next.js", "TypeScript", "Supabase", "Drizzle", "Vercel AI", "OAuth 2.0"],
  ...
  },
  {
    id: "02",
    title: "EduNexus",
    sub: "Academic Utility Tool",
    desc: "Full-stack academic utility app featuring barcode attendance, fee management, and result generation. Containerized with Docker and established a robust CI/CD pipeline for automated deployments.",
    tags: ["Django", "Python", "PostgreSQL", "Docker", "GitHub Actions", "CI/CD"],
  ...
  },
  {
    ...
    desc: "Engineered a travel booking platform for seamless end-to-end flight and hotel reservations. Implemented secure user authentication and complex booking workflows, rigorously tested using Postman. Optimized database architecture and Hibernate queries, reducing system response time by 20%.",
    tags: ["Java", "Spring Boot", "Hibernate", "JDBC", "SQL", "Postman"],
    url: "https://github.com/akshatdhanak",
    accent: "var(--cyan)",
    status: "DEPLOYED",
  },
  {
    id: "04",
    title: "StoryMate",
    sub: "AI Storytelling Platform",
    desc: "Architected an AI-powered interactive storytelling platform utilizing .NET Core for dynamic content generation. Integrated advanced NLP models for personalized, user-driven branching narratives. Engineered a highly scalable backend supporting concurrent users with minimal latency.",
    tags: ["C#", ".NET Core", "NLP", "Entity Framework", "SQL Server"],
    url: "https://github.com/akshatdhanak",
    accent: "var(--purple)",
    status: "WIP",
  },
