...
const items = [
  {
    ...
    company: "Fuzzy Cloud",
    desc: "Led backend architecture for high-concurrency real-time platforms. Designed a real-time communication layer supporting rapid concurrency scaling. Built a Chrome extension with page capture, smart retries, and local storage fallback. Collaborated on a large-scale TypeScript codebase within an agile 5-person engineering team.",
    tags: ["TypeScript", "Node.js", "React", "Chrome Extensions", "System Design"],
    accent: "var(--blue)",
    index: "01",
  },
  {
    ...
    desc: "Final-year student. Core coursework in DSA, DBMS, OS, Computer Networks, AI/ML, and Software Engineering. Data Science enthusiast building production-grade systems.",
    tags: ["DSA", "DBMS", "OS", "AI/ML", "Data Science"],
    accent: "var(--purple)",
    index: "02",
  },
  {
    period: "2023",
    role: "HSC (Science) — 96.67% PR",
    company: "OAJ Institute of Science",
    desc: "12th Standard (HSC) — Science stream. Achieved 96.67 percentile with 99.16 PR in GUJCET and a perfect 40/40 in Mathematics.",
    tags: ["GUJCET: 99.16 PR", "Maths: 40/40", "Science"],
    accent: "var(--orange)",
    index: "03",
  },
  {
    period: "2021",
    role: "SSC — 90%",
    company: "Home School (English Medium)",
    desc: "10th Standard (SSC) — English Medium. Achieved 90% with 97.75 PR.",
    tags: ["PR: 97.75", "90%", "English Medium"],
    accent: "var(--cyan)",
    index: "04",
  },
];
